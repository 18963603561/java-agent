...
public class OllamaProviderAdapter implements ModelProviderAdapter {
    ...
    public OllamaProviderAdapter(WebClient.Builder webClientBuilder,
    ...
    public ModelResponse invoke(ModelDefinition definition, ModelRequest request) {
        ...
        Map<String, Object> body = requestBodyBuilder.buildOllamaRequestBody(modelId, request);
        ...
        String content = responseExtractor.extractOllamaContent(response);
        int inputTokens = responseExtractor.extractOllamaTokens(response, "prompt_eval_count");
        int outputTokens = responseExtractor.extractOllamaTokens(response, "eval_count");
