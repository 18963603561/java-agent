 ...
 */
@Component
public class ToolArgumentValidatorRuntime {

    private static final Logger log = LoggerFactory.getLogger(ToolArgumentValidatorRuntime.class);

    private final ToolRegistry toolRegistry;

    public ToolArgumentValidatorRuntime(ToolRegistry toolRegistry) {
