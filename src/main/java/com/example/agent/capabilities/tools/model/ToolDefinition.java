package com.example.agent.capabilities.tools.model;
 ...
 * 工具定义。
 *
 * <p>用途：作为 tools 域中立模型，承载工具元数据与输入输出结构。</p>
 */
public class ToolDefinition {
    ...
    public ToolDefinition(String name, String version, String description,
