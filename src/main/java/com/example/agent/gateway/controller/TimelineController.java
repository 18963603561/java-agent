...
import com.example.agent.history.EventLogPage;
import com.example.agent.history.EventLogService;
import com.example.agent.history.EventQuery;
import com.example.agent.history.TimelineRequest;
import com.example.agent.history.TimelineResponse;
import com.example.agent.runtime.StepRuntimeService;
import com.example.agent.runtime.StepTimelineResponse;
...
public class TimelineController {
    ...
    private final com.example.agent.history.TimelineService timelineService;
    private final StepRuntimeService stepRuntimeService;
    private final AuthService authService;

    public TimelineController(EventLogService eventLogService,
                              com.example.agent.history.TimelineService timelineService,
